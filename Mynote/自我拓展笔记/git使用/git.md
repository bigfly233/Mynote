...
```
会生成.ssh文件夹，文件夹中有公钥和私钥，将公钥加入github

2. 将公钥加入git hub
![](2022-09-18-12-06-16.png)
3. 这时显示ssh可以用了
![](2022-09-18-12-07-08.png)
4. 可以通过ssh可以pull和push代码
## IDEA集成Git
### 配置Git忽略文件
1. 为什么要忽略？
答：与项目实际功能无关，不参与服务器部署和运行，将其屏蔽可以忽略IDE工具之间的差异
**流程**：
    1. 生成.ignore文件
    2. 配置gitconfig文件
### 定位Git程序
![](2022-09-18-13-00-07.png)
### 初始化本地库
1. SVC创建git本地库
2. 通过git 提交暂存区
   ![](2022-09-18-13-14-04.png)
3. 提交到本地库
由于配置了文件，可以忽略到不用的文件
### 切换版本
1. 当文件被修改的时候，文件会变为绿色
2. 可以直接commit添加到本地仓库，不需要添加到暂存区，因为代码已经被最终
3. 切换版本
   1. 点击git
   ![](2022-09-18-16-55-40.png)
   这时候会用两个指针，一个是指向分支，一个指向版本
   2. 选择版本，右键选择checkout revision
### 创建分支
### 切换分支
### 合并分支
### 解决冲突